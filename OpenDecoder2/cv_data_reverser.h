...
// Content          Name       CV  -alt  type    comment
   ...
   15,          //  T_on_F1     515   3  O       Time on F1  !! Note: we need all pulsed, otherwise we get a reinit
   ...
   0,           //  LastState   544  32  -       saved last port state (was reserved)
                ...
                //
   5,           //  MODE        545  33  -      global decoder mode
   ...
   // REVERSER_ENABLED == TRUE
   0xFD,        //  K1_Trg1_normal 551  39    = 0b1111 1101
   0x00,        //  K1_Trg2_normal 552  40
   0xFE,        //  K1_Trg1_invers 553  41    = 0b1111 1110
   0x00,        //  K1_Trg2_invers 554  42
   0xF7,        //  K2_Trg1_normal 551  43    = 0b1111 0111
   0x00,        //  K2_Trg2_normal 552  44
   0xFB,        //  K2_Trg1_invers 553  45    = 0b1111 1011
   0x00,        //  K2_Trg2_invers 554  46
